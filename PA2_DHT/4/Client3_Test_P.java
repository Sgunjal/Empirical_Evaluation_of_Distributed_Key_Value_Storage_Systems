...
public class Client3_Test_P extends Thread
{
	String type;
	...
	int k=0;
	Client3_Test_P(String type)
	{
		this.type=type;
	}
	Client3_Test_P(Socket s,String type)
	{
		this.type=type;
		incoming_socket=s;
	}
	...
	{		
		try
		{
			if(type.equals("Server"))
			{
				...
				{
					 Socket s = ss.accept();  		
					 Thread t1 =new Client3_Test_P(s,"Request");		
					 t1.start();
				}				
			}
			else
	 ...
	 public static void main(String args[]) throws Exception
	{
		...
		{			
			...
			Client3_Test_P ct=new Client3_Test_P("Client");
			Thread t=new Client3_Test_P("Server");		
			t.start();
			ct.client_side();
		}
		catch(Exception e)

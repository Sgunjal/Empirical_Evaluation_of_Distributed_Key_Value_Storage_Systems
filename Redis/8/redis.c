...
int main() 
{
    int i;
    int instance=8;
    const char *ip_address[16] = {"172.31.15.46", "172.31.15.168", "172.31.10.12", "172.31.4.158", "172.31.10.142", "172.31.2.134", "172.31.1.114", "172.31.5.188"}; 
    int port[16]={6379,6379,6379,6379,6379,6379,6379,6379};
